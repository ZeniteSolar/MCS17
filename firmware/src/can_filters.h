...
{
    // Group 0
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_MCS), // Filter 0
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_MCS), // Filter 1

    // Group 1
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_MCS), // Filter 2
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_MCS), // Filter 3
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_MCS), // Filter 4
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_MCS), // Filter 5
